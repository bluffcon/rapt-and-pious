...
execute store result score @s raptap.random run random value 1..7
...
execute if score @s raptap.random matches 2 align xyz positioned ~.5 ~.5 ~.5 run return run function raptap:enchants/clawing/outcomes/endermite
...
execute if score @s raptap.random matches 7 align xyz positioned ~.5 ~.5 ~.5 run return run function raptap:enchants/clawing/outcomes/kill_nearest/as_nearest
